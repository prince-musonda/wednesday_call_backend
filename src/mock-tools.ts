...
const queryKnowledgeBaseSchema = JSON.stringify({
  ...
  properties: {
    orgId: {
      type: "string",
      description:
        "The unique identifier of the organisation whose knowledge base to query",
    },
    query: {
      type: "string",
...
async function queryKnowledgeBase({
  ...
  try {
    ...
    console.log(
      `##############################################results from knowledge base: {data.result}`,
    );
    ...
    return {
      result:
        "I could not retrieve that information right now. Please try again in a moment.",
    };
  }
}
...
const queryKnowledgeBaseToolSpec = {
  toolSpec: {
    ...
    description:
      "Search the organisation's knowledge base to answer a caller's question. Use this whenever you need information about the organisation.",
...
const saveSummarySchema = JSON.stringify({
  ...
  properties: {
    orgId: {
      type: "string",
      description:
        "The unique identifier of the organisation this call was for",
    },
    summary: {
      type: "string",
      description:
        "A detailed summary of the entire conversation including topics discussed, questions asked, and any information provided",
    },
  },
...
const saveSummaryToolSpec = {
  toolSpec: {
    name: "saveSummary",
    description:
      "Save a detailed summary of the conversation at the end of the call. Always invoke this tool before the call ends.",
